...
All generated files for this workflow must be written under `scripts/ralph/`.
...
Ralph spawns a fresh Codex instance per iteration with no memory of previous work. If a story is too big, the LLM runs out of context before finishing and produces broken code.
