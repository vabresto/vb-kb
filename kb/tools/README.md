...
- Scope: staged markdown files matching canonical v2 files in `data/person/.../person@.../index.md`, `data/org/.../org@.../index.md`, and long-form source-note records `data/source/.../source@reflections-long-form-.../index.md`.
...
uv run python kb/tools/check_entity_links.py data/source/re/source@reflections-long-form-2026-02-19-post-mortem-inbot/index.md
...
uvx prek run kb-entity-first-mention-links --files data/source/re/source@reflections-long-form-2026-02-19-post-mortem-inbot/index.md
uvx prek run kb-newly-added-urls-reachable --all-files
uv run kb validate --pretty
uv run kb validate --changed --pretty
uv run kb derive-employment-edges
uv run kb derive-citation-edges
...
MkDocs is wired to generate view-only site content from `data/` (including `data/source/`) into `.build/docs/` on every build.
