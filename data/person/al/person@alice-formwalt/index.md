...
follow-up-due: null
next-step: Share relevant intros for PM-type roles and relevant producer conversations,
  plus practical feedback loops for her board game prototyping startup exploration.
intro-paths: []
focus-areas:
- product management
...
- Literal source note: [Coffee Chat Debrief Notes - Alice Formwalt (Literal)](../../../source/de/source@debriefs-2026-02-19-coffee-chat-debrief-alice-formwalt/index.md)
...
- [2026-02-20] Saved a verbatim copy of the debrief in [Coffee Chat Debrief Notes - Alice Formwalt (Literal)](../../../source/de/source@debriefs-2026-02-19-coffee-chat-debrief-alice-formwalt/index.md).
