...
stages: []
check-size:
thesis: Website experience platform for designing, building, and managing websites.
focus-sectors:
- web development
- design tooling
portfolio-examples: []
...
Webflow describes itself as a Website Experience Platform where teams can build, manage, and optimize websites that convert.[^webflow-source]
...
[^webflow-source]: Source: [About Webflow](https://webflow.com/company/about). Verified/accessed on 2026-02-16.
